...
const ProjectCard = () => {
  const projects = [
    ...
    },
    {
      ...
      title: 'SkySense',
      description:
      'A full-stack weather dashboard that delivers real-time weather data, 5-day forecasts, travel scores, weather alerts, clothing recommendations, and AI-powered summaries using Open-Meteo APIs.',
      technologies: [
        'React',
        'Node.js',
        'Express.js',
